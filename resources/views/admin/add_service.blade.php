      ...
      <div class="card-body">
        <form class="needs-validation" novalidate>
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="bs-validation-name" placeholder="job name" required />
            <div class="valid-feedback"> Looks good! </div>
            <div class="invalid-feedback"> Please enter job name. </div>
          </div>
          <div class="mb-3">
            <label class="form-label" for="bs-validation-salary">Salary</label>
            <input type="number" id="bs-validation-email" class="form-control" placeholder="$" aria-label="$" required />
            <div class="valid-feedback"> Looks good! </div>
