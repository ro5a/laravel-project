        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <form id="formAuthentication" class="mb-3" action="{{ route('save_user') }}" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="username" name="full_name" placeholder="Enter your full name" autofocus>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 form-password-toggle">
              ...
              <div class="input-group input-group-merge">
                <input type="password" id="password" class="form-control" name="confirm_pass" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
              </div>
            </div>
